...
#include <stdio.h>
#include <string.h>
#include "fix_ssa_tsdpd_bvf_artificial_stress.h"
#include <math.h>
#include <stdlib.h>
#include <string.h>
#include "atom.h"
...
FixSsaTsdpdBvfArtificialStress::FixSsaTsdpdBvfArtificialStress(LAMMPS *lmp, int narg, char **arg) :
    Fix(lmp, narg, arg) {
...
int FixSsaTsdpdBvfArtificialStress::setmask() {
    int mask = 0;
...
void FixSsaTsdpdBvfArtificialStress::init() {
    dtv = update->dt;
...
void FixSsaTsdpdBvfArtificialStress::setup_pre_force(int vflag)
{
    // set vest equal to v
    double **v = atom->v;
...
void FixSsaTsdpdBvfArtificialStress::initial_integrate(int vflag) {
...
void FixSsaTsdpdBvfArtificialStress::final_integrate() {
...
void FixSsaTsdpdBvfArtificialStress::reset_dt() {
    dtv = update->dt;
    dtf = 0.5 * update->dt * force->ftm2v;
}
